...
public class LoanControllerTest {
    ...
    public void createLoanTest() throws Exception {
        ...
        // faz a busca do livro na base passando o id e o isbn se achar
        // retorna o livro para fazer o emprestimo.
        Book book = Book.builder().id(1l).isbn("123").build();
        BDDMockito.given(bookService.getBookByIsbn("123")).willReturn(Optional.of(book));

        // faz o emprestimo com o livro buscado
    ...
    public void invalidIsbnCreateLoanTest() throws Exception {
        ...
        // faz a busca do livro e retorna vazio
    ...
    public void returnBookTest() throws Exception {
        ...
        // verifica se o metodo passou no update
